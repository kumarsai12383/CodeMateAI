...
export function handleSignupForm(submitCallback) {
  ...
  signupForm.addEventListener("submit", async function (e) {
    e.preventDefault();
    const name = signupForm.querySelector('input[type="text"]').value.trim().toLowerCase();
    const email = signupForm.querySelector('input[type="email"]').value.trim().toLowerCase();
    const password = signupForm.querySelector('input[type="password"]').value.toLowerCase();
    if (typeof submitCallback === "function") {
